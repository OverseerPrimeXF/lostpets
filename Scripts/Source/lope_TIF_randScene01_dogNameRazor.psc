...
Scriptname lope_TIF_randScene01_dogNameRazor Extends TopicInfo Hidden
...
(getOwningQuest() as lope_randomScenes01Controller).dogCurrentName  = 2

DogNameRazor.forceRefTo(akSpeaker)
;END CODE
EndFunction
;END FRAGMENT
