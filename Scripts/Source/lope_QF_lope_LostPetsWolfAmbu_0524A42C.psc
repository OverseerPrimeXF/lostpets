...
;alias_LostPetMarker.forceRefTo(PetMarker)
...
sl.IncreaseRelationship(alias_wolfEnc01.getActorRef())
sl.IncreaseRelationship(alias_wolfEnc02.getActorRef())
conditions.iTimesWolvesAmbushed  += 1
...
; CompleteAllObjectives()
SetObjectiveDisplayed(150)
; SetObjectiveCompleted(150, false)
; debug.messagebox("stage 150")
WAC.registerAndGetStage(12)
