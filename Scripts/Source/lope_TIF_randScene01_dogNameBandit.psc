...
Scriptname lope_TIF_randScene01_dogNameBandit Extends TopicInfo Hidden
...
(getOwningQuest() as lope_randomScenes01Controller).dogCurrentName  = 0

DogNameBandit.forceRefTo(akSpeaker)
;END CODE
EndFunction
;END FRAGMENT
